...
class SampleApp(tk.Tk):
    ...
    def time_to_epoch(self, date_time):
        #12.06.2017-1:00
        date_time += ":00"
        pattern = '%d.%m.%Y-%H:%M:%S'
    ...
    def signin(self, page_name, uname, pword, infolabel):
        global connected
        global ser
        global comportC
        ...
        if connected == 0:
            self.configuration(comportC, infolabel)
        elif connected == 1:
            usrname = ""
            passwd = ""
            ...
            while usrname =="":
                try:
                    ...
                    logging.exception("Oops:")
                    self.change_label(infolabel, "No Serial link")
            ...
            if state == "True":
                ...
                self.geometry(geometry)
                frame.tkraise()
                self.request_state(Button1, Button2, Button3, Button4, Button5, Button6, Button7, Button8)
            elif state == "False":
    ...
    def selected_on(self,rl1,rl2,rl3,rl4,rl5,rl6,rl7,rl8,bt1,bt2,bt3,bt4,bt5,bt6,bt7,bt8,logger):
        ...
        try:
            if rl1.get()==1:
                ...
                self.request_state_individual("1",bt1)
            elif rl1.get()==0:
                ser.write("2")
                time.sleep(0.075)
                #statusW = ser.readline()+"-------------"+self.fetch_timestamp()
        ...
        try:
            if rl2.get()==1:
                ...
                self.request_state_individual("2",bt2)
            elif rl2.get()==0:
                ser.write("4")
                time.sleep(0.075)
                #statusW = ser.readline()+"-------------"+self.fetch_timestamp()
        ...
        try:
            if rl3.get()==1:
                ...
                self.request_state_individual("3",bt3)
            elif rl3.get()==0:
                ser.write("6")
                time.sleep(0.075)
                #statusW = ser.readline()+"-------------"+self.fetch_timestamp()
        ...
        try:
            if rl4.get()==1:
                ...
                self.request_state_individual("4",bt4)
            elif rl4.get()==0:
                ser.write("8")
                time.sleep(0.075)
                #statusW = ser.readline()+"-------------"+self.fetch_timestamp()
        ...
        try:
            if rl5.get()==1:
                ...
                self.request_state_individual("5",bt5)
            elif rl5.get()==0:
                ser.write("10")
                time.sleep(0.075)
                #statusW = ser.readline()+"-------------"+self.fetch_timestamp()
        ...
        try:
            if rl6.get()==1:
                ...
                self.request_state_individual("6",bt6)
            elif rl6.get()==0:
                ser.write("12")
                time.sleep(0.075)
                #statusW = ser.readline()+"-------------"+self.fetch_timestamp()
        ...
        try:
            if rl7.get()==1:
                ...
                self.request_state_individual("7",bt7)
            elif rl7.get()==0:
                ser.write("14")
                time.sleep(0.075)
                #statusW = ser.readline()+"-------------"+self.fetch_timestamp()
        ...
        try:
            if rl8.get()==1:
                ...
                self.request_state_individual("8",bt8)
            elif rl8.get()==0:
                ser.write("16")
                time.sleep(0.075)
                #statusW = ser.readline()+"-------------"+self.fetch_timestamp()
    ...
    def serial_check(self):
        ...
        try:
            ser.write("l")
            serial_line = self.after(300,lambda: self.serial_check())
        except serial.serialutil.SerialException:
            self.after_cancel(serial_line)
            self.after_cancel(recur)
            connected = 0
    ...
    def first_index_search(self,start_time):

        count = 2
        position = "J"+str(count)
        data = sheetC[position]
        data_fetched = data.internal_value
        data_fetched_int = int(data_fetched)

        while (data_fetched_int < start_time):
            count=count+1
            position = "J"+str(count)
            data = sheetC[position]
            data_fetched = data.internal_value
    ...
    def last_index_search(self,stop_time):
        ...
        while (data_fetched_int < stop_time):
            count=count+1
            position = "J"+str(count)
            data = sheetC[position]
            data_fetched = data.internal_value
    ...
    def plot(self,canvas,page_name,entryObj1,entryObj2):

        start_time = self.time_to_epoch(self.fetch_entry_data(entryObj1))
        #print start_time
        stop_time = self.time_to_epoch(self.fetch_entry_data(entryObj2))
        #print stop_time
        ...
        if page_name == "graphRelay1":
            ...
            first_count = self.first_index_search(start_time)
            last_count = self.last_index_search(stop_time)
...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        Button1 = tk.Button(self, command=lambda: controller.signin("PageOne",self.Entry1,self.Entry2, Label5))
        ...
        options = list(self.serial_ports())
        om_variable = tk.StringVar(self)
        
        om_variable.set("COM select")
        

        #comportC = options[0]
        om_variable.trace('w', self.option_select)
        
        om = tk.OptionMenu(self, om_variable, *options)
        om.place(relx=0.4, rely=0.62)
        
        Label5 = tk.Label(self)
        Label5.place(relx=0.38, rely=0.89)
    ...
    def update_option_menu(self):
        ...
        for port in serial.tools.list_ports.comports():
            menu.add_command(label=port, 
                             command=lambda value=port: om_variable.set(value))
    ...
    def option_select(self, *args):
        ...
        connected = 0
        comportc = om_variable.get()
        comportb = comportc.split(" ")
        comportC = comportb[0]
...
class PageOne(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        Button1 = tk.Button(self, command=lambda: controller.control_button("1",Button1,logger))
        ...
        Button2 = tk.Button(self, command=lambda: controller.control_button("2",Button2,logger))
        ...
        Button3 = tk.Button(self, command=lambda: controller.control_button("3",Button3,logger))
        ...
        Button4 = tk.Button(self, command=lambda: controller.control_button("4",Button4,logger))
        ...
        Button5 = tk.Button(self, command=lambda: controller.control_button("5",Button5,logger))
        ...
        Button6 = tk.Button(self, command=lambda: controller.control_button("6",Button6,logger))
        ...
        Button7 = tk.Button(self, command=lambda: controller.control_button("7",Button7,logger))
        ...
        Button8 = tk.Button(self, command=lambda: controller.control_button("8",Button8,logger))
...
class graphRelay1(tk.Frame):
    def __init__(self, parent, controller):
        ...
        button1 = tk.Button(self, text="Plot",command=lambda: controller.plot(canvas,"graphRelay1",Entry1, Entry2))
        button1.pack()
        ...
        label1 = tk.Label(self, text="Start Time [dd.mm.yyyy-hh:mm]")
        label1.pack()
        Entry1 = tk.Entry(self)
        Entry1.pack()

        label2 = tk.Label(self, text="Stop Time [dd.mm.yyyy-hh:mm]")
        label2.pack()
...
class graphRelay2(tk.Frame):
    def __init__(self, parent, controller):
        ...
        button1 = tk.Button(self, text="Plot",command=lambda: controller.plot(canvas,"graphRelay2",Entry1, Entry2))
        button1.pack()
...
class graphRelay3(tk.Frame):
    def __init__(self, parent, controller):
        ...
        button1 = tk.Button(self, text="Plot",command=lambda: controller.plot(canvas,"graphRelay3",Entry1, Entry2))
        button1.pack()
...
class graphRelay4(tk.Frame):
    def __init__(self, parent, controller):
        ...
        button1 = tk.Button(self, text="Plot",command=lambda: controller.plot(canvas,"graphRelay4",Entry1, Entry2))
        button1.pack()
...
class graphRelay5(tk.Frame):
    def __init__(self, parent, controller):
        ...
        button1 = tk.Button(self, text="Plot",command=lambda: controller.plot(canvas,"graphRelay5",Entry1, Entry2))
        button1.pack()
...
class graphRelay6(tk.Frame):
    def __init__(self, parent, controller):
        ...
        button1 = tk.Button(self, text="Plot",command=lambda: controller.plot(canvas,"graphRelay6",Entry1, Entry2))
        button1.pack()
...
class graphRelay7(tk.Frame):
    def __init__(self, parent, controller):
        ...
        button1 = tk.Button(self, text="Plot",command=lambda: controller.plot(canvas,"graphRelay7",Entry1, Entry2))
        button1.pack()
...
class graphRelay8(tk.Frame):
    def __init__(self, parent, controller):
        ...
        button1 = tk.Button(self, text="Plot",command=lambda: controller.plot(canvas,"graphRelay8",Entry1, Entry2))
        button1.pack()
